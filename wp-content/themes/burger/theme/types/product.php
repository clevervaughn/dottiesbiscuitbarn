...
class ctProductType extends ctTypeBase
{
    ...
    protected function registerType() {
        $typeData = $this->callFilter('pre_register_type', array(
            'labels' => array(
                ...
                'singular_name' => _x('Product items Item', 'post type singular name', 'ct_theme'),
                'add_new' => _x('Add New', 'product items', 'ct_theme'),
    ...
    protected function getPermalinkSlug() {
        ...
        $permalink_slug = ct_get_option('product', 'product');
    ...
    public function productTemplateMeta()
    {
        global $post;
        $custom = get_post_custom($post->ID);
