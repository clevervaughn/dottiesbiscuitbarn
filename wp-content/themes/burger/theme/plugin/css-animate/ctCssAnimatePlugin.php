...
class ctCssAnimatePlugin {
	...
	protected function getCompatibleShortcodes() {
		$shortcodes = array(
				'five_sixth_column', 'full_column', 'full_width', 'half_column', 'one_sixth_column', 'quarter_column', 'row', 'third_column', 'three_quarters_column','five_twelfths_column', 'seven_twelfths_column', 'title_row', 'two_thirds_column'
		);
	...
	public function addCustomNormalizedAttributes($attr) {
		$attr['animation'] = array('label' => __('animation', 'ct_theme'), 'default' => '', 'type' => 'select', 'choices' =>
				array(
						"" => __("none", "ct_theme"),
						array(
				...
				), 'help' => sprintf(__('Animate this element once it becomes visible. Supported animations: %s', 'ct_theme'), '<a href="https://daneden.me/animate/">https://daneden.me/animate/</a>'));
		return $attr;
	}
